...
def EstimateProjectionMatrix(points2D, points3D):
    ...
    #  Hint: Pay attention to the assumed order of the vectorized P matrix. You will need
    #  the same order when reshaping the vector to the matrix later
...
def DecomposeP(P):
    ...
    R_hat = np.linalg.inv(R_hat_inv)11§ 1
